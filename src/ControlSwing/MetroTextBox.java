...
public class MetroTextBox extends JTextField implements ComponentListener {
    ...
    //imagenes X
    private ImageIcon iconBlack = new ImageIcon(getClass().getResource("/iconMetroTextBox/metro_x_b.png"));
    private ImageIcon iconWhite = new ImageIcon(getClass().getResource("/iconMetroTextBox/metro_x_w.png"));
