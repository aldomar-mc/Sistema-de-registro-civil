 ...
 * @author Aldo Omar
 */
public class JInt_TipoUsuario extends javax.swing.JInternalFrame {
    ...
    public JInt_TipoUsuario() {
        ...
        tituloTabla();
        cargarTabla();
        tabla.tablaNoEditable(jTableTipoUsuario);
    }

    public void limpiarCampos() {
        controlador.limpiarJTexField(jCTextFieldTipoUsuario);
    }

    public void estadoCampos(boolean estado) {
        jCTextFieldTipoUsuario.setEnabled(estado);
    }
    ...
    public void cargarTabla() {
        tabla.MostrarEnTabla("CALL listTipoUsuario()", jTableTipoUsuario, modelo, 2);
        tabla.setMaxWidthColumnTable(jTableTipoUsuario, 30, 0);
    }

    public void buscarTipoUsuario() {
        controlador.BuscarDato("CALL searchTipoUsuario(?)", modelo, 2, jCTextFieldBuscar);
    }

    public void insertarTipoUsuario() {
        try {
            String sql = "CALL insertTipoUsuario("
                    + "'" + jCTextFieldTipoUsuario.getText() + "'"
                    + " );";
            mensaje.mensajeInformacion(consulta.CrearRegistro(sql));
        } catch (Exception e) {
            mensaje.mensajeError("Insertar Tipo usuario");
        }
    }

    public void editarTipoUsuario() {
        try {
            String sql = "CALL editTipoUsuario("
                    + "'" + jCTextFieldTipoUsuario.getText() + "',"
                    + "'" + idtipousuario + "'"
                    + " );";
            mensaje.mensajeInformacion(consulta.CrearRegistro(sql));
        } catch (Exception e) {
            mensaje.mensajeError("Editar Tipo usuario");
        }
    }

    public void eliminarTipoUsuario() {
        try {
            String sql = "CALL deleteTipoUsuario("
                    + "'" + idtipousuario + "'"
                    + " );";
            mensaje.mensajeInformacion(consulta.CrearRegistro(sql));
        } catch (Exception e) {
            mensaje.mensajeError("Eliminar Tipo usuario");
        }
    }

    public boolean ValidarCampos() {
        boolean valor = false;
        if (jCTextFieldTipoUsuario.getText().length() != 0) {
            valor = true;
        } else {
            mensaje.mensajeError("Debe ingresar nombre del tipo usuario.");
            jCTextFieldTipoUsuario.requestFocus();
        }
        return valor;
    }
    ...
    public void asignarCampos() {
        try {
            idtipousuario = modelo.getValueAt(jTableTipoUsuario.getSelectedRow(), 0).toString();
            controlador.asignarJTexField(jCTextFieldTipoUsuario, modelo, jTableTipoUsuario, 1);
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jCTextFieldTipoUsuario = new ControlSwing.JCTextField();
        ...
        setTitle("MANTENIMIENTO DE TIPO USUARIO");

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        jPanel2.setBackground(new java.awt.Color(255, 255, 255));
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 51, 255), 3), "DATOS DE TIPO USUARIO", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(0, 51, 255))); // NOI18N

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel1.setText("Tipo usuario");

        jCTextFieldTipoUsuario.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jCTextFieldTipoUsuario.setPlaceholder("Ingrese tipo usuario");
        jCTextFieldTipoUsuario.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCTextFieldTipoUsuarioActionPerformed(evt);
            }
        });
        jCTextFieldTipoUsuario.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jCTextFieldTipoUsuarioKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jCTextFieldTipoUsuarioKeyTyped(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jCTextFieldTipoUsuario, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(jCTextFieldTipoUsuario, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 51, 255), 3), "LISTADO DE TIPOS DE USUARIO", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(0, 51, 255))); // NOI18N
        ...
        jTableTipoUsuario.setComponentPopupMenu(jPopupMenu1);
        jScrollPane1.setViewportView(jTableTipoUsuario);
    ...
    private void jCTextFieldTipoUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCTextFieldTipoUsuarioActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jCTextFieldTipoUsuarioActionPerformed
    ...
    private void jMenuItemModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemModificarActionPerformed
        ...
        int filamodificar = jTableTipoUsuario.getSelectedRow();
        if (filamodificar >= 0) {
            asignarCampos();
        } else {
    ...
    private void jCTextFieldTipoUsuarioKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jCTextFieldTipoUsuarioKeyReleased
        // TODO add your handling code here:
        evento.mayusculas(evt, jCTextFieldTipoUsuario);
    }//GEN-LAST:event_jCTextFieldTipoUsuarioKeyReleased

    private void jCTextFieldTipoUsuarioKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jCTextFieldTipoUsuarioKeyTyped
        // TODO add your handling code here:
        evento.soloLetras(evt);
        evento.soloNcarc(45, jCTextFieldTipoUsuario, evt);
        evento.SinEspacioBlancoJTextField(evt, jCTextFieldTipoUsuario);
    }//GEN-LAST:event_jCTextFieldTipoUsuarioKeyTyped
    ...
    private ControlSwing.JCTextField jCTextFieldTipoUsuario;
