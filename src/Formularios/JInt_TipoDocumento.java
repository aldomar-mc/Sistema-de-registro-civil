 ...
 * @author Aldo Omar
 */
public class JInt_TipoDocumento extends javax.swing.JInternalFrame {
    ...
    public JInt_TipoDocumento() {
        ...
        tituloTabla();
        cargarTabla();
        tabla.tablaNoEditable(jTableTipoDocumento);
    }

    public void limpiarCampos() {
        controlador.limpiarJTexField(jCTextFieldTipoDoc);
    }

    public void estadoCampos(boolean estado) {
        jCTextFieldTipoDoc.setEnabled(estado);
    }
    ...
    public void tituloTabla() {
        String[] titulo = {"ID", "TIPO DOCUMENTO"};
        modelo = new DefaultTableModel(null, titulo);
        modelo.setColumnIdentifiers(titulo);
        jTableTipoDocumento.setModel(modelo);
    }

    public void cargarTabla() {
        tabla.MostrarEnTabla("CALL listTipoDocumento()", jTableTipoDocumento, modelo, 2);
        tabla.setMaxWidthColumnTable(jTableTipoDocumento, 30, 0);
    }

    public void buscarTipoDocumento() {
        controlador.BuscarDato("CALL searchTipoDocumento(?)", modelo, 2, jCTextFieldBuscar);
    }

    public void insertarTipoDocumento() {
        try {
            String sql = "CALL insertTipoDocumento("
                    + "'" + jCTextFieldTipoDoc.getText() + "'"
                    + " );";
            mensaje.mensajeInformacion(consulta.CrearRegistro(sql));
        } catch (Exception e) {
            mensaje.mensajeError("Insertar Tipo documento");
        }
    }

    public void editarTipoDocumento() {
        try {
            String sql = "CALL editTipoDocumento("
                    + "'" + jCTextFieldTipoDoc.getText() + "',"
                    + "'" + idtipodocumento + "'"
                    + " );";
            mensaje.mensajeInformacion(consulta.CrearRegistro(sql));
        } catch (Exception e) {
            mensaje.mensajeError("Editar Tipo documento");
        }
    }

    public void eliminarTipoDocumento() {
        try {
            String sql = "CALL deleteTipoDocumento("
                    + "'" + idtipodocumento + "'"
                    + " );";
            mensaje.mensajeInformacion(consulta.CrearRegistro(sql));
        } catch (Exception e) {
            mensaje.mensajeError("Eliminar Tipo documento");
        }
    }

    public boolean ValidarCampos() {
        boolean valor = false;
        if (jCTextFieldTipoDoc.getText().length() != 0) {
            valor = true;
        } else {
            mensaje.mensajeError("Debe ingresar nombre del documento.");
            jCTextFieldTipoDoc.requestFocus();
        }
        return valor;
    }
    ...
    public void asignarCampos() {
        try {
            idtipodocumento = modelo.getValueAt(jTableTipoDocumento.getSelectedRow(), 0).toString();
            controlador.asignarJTexField(jCTextFieldTipoDoc, modelo, jTableTipoDocumento, 1);
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jCTextFieldTipoDoc = new ControlSwing.JCTextField();
        ...
        jTableTipoDocumento = new javax.swing.JTable();
        ...
        setTitle("MANTENIMIENTO DE TIPO DOCUMENTO");

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        jPanel2.setBackground(new java.awt.Color(255, 255, 255));
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 51, 255), 3), "DATOS DE TIPO DOCUMENTO", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(0, 51, 255))); // NOI18N

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel1.setText("Tipo documento");

        jCTextFieldTipoDoc.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        jCTextFieldTipoDoc.setPlaceholder("Ingrese tipo documento");
        jCTextFieldTipoDoc.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCTextFieldTipoDocActionPerformed(evt);
            }
        });
        jCTextFieldTipoDoc.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jCTextFieldTipoDocKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jCTextFieldTipoDocKeyTyped(evt);
            }
        });
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(jCTextFieldTipoDoc, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel1)
                    .addComponent(jCTextFieldTipoDoc, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 51, 255), 3), "LISTADO DE TIPOS DE DOCUMENTO", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 14), new java.awt.Color(0, 51, 255))); // NOI18N

        jTableTipoDocumento.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        jTableTipoDocumento.setComponentPopupMenu(jPopupMenu1);
        jScrollPane1.setViewportView(jTableTipoDocumento);
    ...
    private void jCTextFieldTipoDocActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCTextFieldTipoDocActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jCTextFieldTipoDocActionPerformed
    ...
    private void jMenuItemModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemModificarActionPerformed
        ...
        int filamodificar = jTableTipoDocumento.getSelectedRow();
        if (filamodificar >= 0) {
            asignarCampos();
        } else {
    ...
    private void jCButtonEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCButtonEditarActionPerformed
        // TODO add your handling code here:
        if (jTableTipoDocumento.getSelectedRow() >= 0) {
    ...
    private void jCTextFieldTipoDocKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jCTextFieldTipoDocKeyReleased
        // TODO add your handling code here:
        evento.mayusculas(evt, jCTextFieldTipoDoc);
    }//GEN-LAST:event_jCTextFieldTipoDocKeyReleased

    private void jCTextFieldTipoDocKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jCTextFieldTipoDocKeyTyped
        // TODO add your handling code here:
        evento.soloLetras(evt);
        evento.soloNcarc(45, jCTextFieldTipoDoc, evt);
        evento.SinEspacioBlancoJTextField(evt, jCTextFieldTipoDoc);
    }//GEN-LAST:event_jCTextFieldTipoDocKeyTyped
    ...
    private ControlSwing.JCTextField jCTextFieldTipoDoc;
    ...
    private javax.swing.JTable jTableTipoDocumento;
